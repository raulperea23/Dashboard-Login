        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="inicio" class="site_title"><i class="fa fa-bar-chart"></i> <span>Dashboard</span></a>
            </div>
            ...
            <img src="${pageContext.request.contextPath}/resources/images/logoalten.png" width="100%"><br>
                  ...
                  <div class="x_content">
                    <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                      <div class="profile_img">
                        <div id="crop-avatar">
                          <!-- Current avatar -->
                          <img class="img-responsive avatar-view" src="${pageContext.request.contextPath}/resources/images/img.jpg" alt="Avatar" title="Change the avatar">
                        </div>
                      </div>
                      <h3>admin</h3>
                      ...
                      <div class="" role="tabpanel" data-example-id="togglable-tabs">
                        ...
                        <div id="myTabContent" class="tab-content">
                          <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                            ...
                            <ul class="messages">
                              <li>
                                <img src="${pageContext.request.contextPath}/resources/images/img.jpg" class="avatar" alt="Avatar">
